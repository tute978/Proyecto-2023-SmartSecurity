...
ffmpeg -y -i C:\AppServ\www\Proyecto-2023-SmartSecurity\RTSP-HLS-SERVER\%NewestFile% -c:v libx264 C:\AppServ\www\Proyecto-2023-SmartSecurity\CameraFiles\%NewestFileMp4%